              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6 border border-gray-200 dark:border-gray-700">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl p-4">
                    <div className="text-sm text-blue-600 dark:text-blue-400">Toplam Bakiye</div>
                    <div className="text-2xl font-bold text-gray-900 dark:text-white">₺25,215</div>
                  ...
                  <div className="bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-xl p-4">
                    <div className="text-sm text-purple-600 dark:text-purple-400">Bu Ay</div>
                    <div className="text-2xl font-bold text-gray-900 dark:text-white">₺2,845</div>
                    <div className="flex items-center gap-1 text-sm text-green-600">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                      </svg>
                ...
                <div className="space-y-3">
                  ...
                  {[
                    { name: 'Market Alışverişi', amount: '-₺125.50', date: 'Bugün, 14:30', type: 'expense' },
                    { name: 'Maaş', amount: '+₺8,500', date: 'Dün, 09:15', type: 'income' },
                    { name: 'Kafe', amount: '-₺45.00', date: '2 gün önce', type: 'expense' }
